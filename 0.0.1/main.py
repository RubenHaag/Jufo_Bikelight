...
LED_COUNT   = 31# Anzahl der LED's auf dem LED-Streifen
...
def bildAuslesen():
    ...
    for i in range(0, LED_COUNT):
        ...
        matrix[1][i] = int((round(cos(k1) * i, 0)*3 + 150))    #Berechnung der X-Koordinate
        matrix[2][i] = int((round(sin(k1) * i, 0)*3 + 150))
...
streifen1 = Adafruit_NeoPixel(LED_COUNT, LED_PIN1, LED_FREQ_HZ, LED_DMA, LED_INVERT, LED_BRIGHTNESS)
