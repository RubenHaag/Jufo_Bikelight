...
\begin{figure}[H]
	...
	\label{Skizze}
\end{figure}
An Stelle der Märklin-Metall-Halterung haben wir eine Platine aus Epoxydharz entworfen und der Ätzvorgang ist in Arbeit. Diese Platine wird von außen mit Hilfe von Katzenaugen befestigen.  
\section{Ergebnis}
